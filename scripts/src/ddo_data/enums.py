...
class S(str, Enum):
    ...
    # --- Stats in seed but not previously in enum ---
    TRIP_DC = "Trip DC"
    SUNDER_DC = "Sunder DC"
    STUN_DC = "Stun DC"
    SEEKER = "Seeker"
    DEADLY = "Deadly"
    ACCURACY = "Accuracy"
    DECEPTION_STAT = "Deception"
    SPEED = "Speed"
    COMBAT_MASTERY = "Combat Mastery"
    TENDON_SLICE = "Tendon Slice"
    NIMBLE = "Nimble"
    ALLURING = "Alluring"
    FORTIFICATION = "Fortification"
    DODGE = "Dodge"
    SAVING_THROWS_VS_TRAPS = "Saving Throws vs Traps"
    CONCEALMENT = "Concealment"
    PROTECTION = "Protection"
    SHELTERING = "Sheltering"
    RESISTANCE = "Resistance"
    POISON_RESISTANCE = "Poison Resistance"
    ALIGNMENT_SPELL_POWER = "Alignment Spell Power"
    WIZARDRY = "Wizardry"
    SPELL_FOCUS_MASTERY = "Spell Focus Mastery"
    RUNE_ARM_SPELL_FOCUS = "Rune Arm Spell Focus"
    SACRED_GROUND_LORE = "Sacred Ground Lore"
    DARK_RESTORATION_LORE = "Dark Restoration Lore"
    WELL_ROUNDED = "Well Rounded"
    LINGUISTICS = "Linguistics"
    CRITICAL_DAMAGE_MULTIPLIER = "Critical Damage Multiplier"
    MELEE_AND_RANGED_POWER = "Melee and Ranged Power"
    POSITIVE_AND_NEGATIVE_SPELL_POWER = "Positive and Negative Spell Power"
    POSITIVE_AND_NEGATIVE_HEALING_AMP = "Positive and Negative Healing Amplification"
    DOUBLESTRIKE_AND_DOUBLESHOT = "Doublestrike and Doubleshot"
    TEMPORARY_HIT_POINTS = "Temporary Hit Points"
    BARD_SONGS = "Bard Songs"
    MAXIMUM_HIT_POINTS = "Maximum Hit Points"
    ARMOR_CLASS_PERCENTAGE = "Armor Class Percentage"
    SPELL_POINT_COST_REDUCTION = "Spell Point Cost Reduction"
    SNEAK_ATTACK_BONUS = "Sneak Attack Bonus"
    RANGED_THREAT_REDUCTION = "Ranged Threat Reduction"
    DAMAGE_VS_EVIL = "Damage vs Evil"
    SONIC_RESISTANCE = "Sonic Resistance"
    LIGHT_RESISTANCE = "Light Resistance"
    FORCE_RESISTANCE = "Force Resistance"
    NEGATIVE_RESISTANCE = "Negative Resistance"
    NEGATIVE_ENERGY_ABSORPTION = "Negative Energy Absorption"
    ELEMENTAL_ABSORPTION_STAT = "Elemental Absorption"
    ALIGNMENT_ABSORPTION = "Alignment Absorption"
    SPELL_ABSORPTION_STAT = "Spell Absorption"
    CURSE_ABSORPTION = "Curse Absorption"
    NEGATIVE_ENERGY_RESISTANCE = "Negative Energy Resistance"
    ELEMENTAL_RESISTANCE_STAT = "Elemental Resistance"
    SPELL_SAVE = "Spell Save"
    FEAR_SAVE = "Fear Save"
    DISEASE_SAVE = "Disease Save"
    SLEEP_SAVE = "Sleep Save"
    TRAP_SAVE = "Trap Save"
    POISON_SPELL_POWER_STAT = "Poison Spell Power"
...
class SkillName(str, Enum):
    ...
    HEAL_SKILL = "Heal"
    HIDE_SKILL = "Hide"
    INTIMIDATE_SKILL = "Intimidate"
    JUMP = "Jump"
    LISTEN = "Listen"
    MOVE_SILENTLY = "Move Silently"
    OPEN_LOCK = "Open Lock"
    PERFORM_SKILL = "Perform"
    REPAIR_SKILL = "Repair"
    SEARCH_SKILL = "Search"
...
class BonusTypeName(str, Enum):
    """Bonus type names (stacking categories)."""
    def __str__(self) -> str: return self.value
    ...
    DODGE_BT = "Dodge"
    ARMOR_BT = "Armor"
    NATURAL_ARMOR_BT = "Natural Armor"
    DEFLECTION = "Deflection"
    SHIELD_BT = "Shield"
    SIZE = "Size"
    RACIAL_BT = "Racial"
    RESISTANCE_BT = "Resistance"
    FESTIVE = "Festive"
