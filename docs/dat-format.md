...
- [x] Add alignment restrictions to classes and iconic races — **DONE.** `alignment` column added to classes table. Paladin=lawful good, Monk=any lawful, Barbarian=any non-lawful, Druid=any neutral, rest=any.
