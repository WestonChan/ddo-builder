...
- [ ] Class/race body decoding — **exhaustively investigated, blocked on proprietary template system**:
  ...
  - **Cross-reference search**: searched ALL bytes/u16s/floats in shared preamble and class-specific sections for known class stats (hit die 6/8/4/4, skills 8/6/2/2, circles 0/4/9/9, BAB 0.75/0.5). **ZERO matches.** Class stats are NOT stored as simple values — they're resolved from template references at runtime.
